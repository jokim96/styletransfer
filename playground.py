...
def calc_style_loss(base_style, output):
        ...
        # style_loss = K.sum(K.square(gram_style - gram_output)) / (4.0 * (channels ** 2) * (size ** 2))
        return style_loss
...
for i in range(num_iterations):
        ...
        #save the images at the project directory for progress
        file = 'images/result_at_%d,(%.2f,%.2f).png' % (i,content_weight,style_weight)
        image.save_img(file, x)
